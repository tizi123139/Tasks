...
- 安装 GORM 和 MySQL 驱动
  ...
  ![屏幕截图 2025-02-19 231304](https://raw.githubusercontent.com/tizi123139/hahaha/main/屏幕截图 2025-02-19 231304.png)
...
![屏幕截图 2025-02-19 232614](https://raw.githubusercontent.com/tizi123139/hahaha/main/屏幕截图 2025-02-19 232614.png)

`gorm.Open`：用于打开一个数据库连接，返回一个 `*gorm.DB` 对象。

`db.AutoMigrate`：该方法会根据定义的模型结构体自动创建或更新对应的数据库表结构。

![屏幕截图 2025-02-20 090154](https://raw.githubusercontent.com/tizi123139/hahaha/main/屏幕截图 2025-02-20 090154.png)
